...
/**
 * LoginPageTest -- verifies the GOG.com login page structure and form
 * behaviour,
...
public class LoginPageTest extends BaseTest {
        ...
        @Test(priority = 2, description = "Verify the login page is served over HTTPS from the GOG auth subdomain")
        ...
        @Test(priority = 3, description = "Verify the email field accepts typed input and its value "
        ...
        @Test(priority = 4, description = "Verify the password field has type='password' to mask input "
        ...
        @Test(priority = 5, description = "Verify submitting a completely empty login form keeps the "
        ...
        @Test(priority = 6, description = "Verify submitting invalid credentials keeps the user on "
                        + "the GOG auth domain")
        ...
        @Test(priority = 9, description = "Verify submitting correct credentials redirects to the GOG store")
        ...
        @Test(priority = 7, description = "Verify clicking the Forgot Password link navigates to the "
        ...
        @Test(priority = 8, description = "Verify clicking the Create Account link navigates to the "
