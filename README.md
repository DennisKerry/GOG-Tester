...
This project applies end-to-end and system-level automated testing to Instagram's
public-facing web application using **Selenium WebDriver**, **TestNG**, and **Maven**.
...
│       │           └── NavigationTest.java
│       └── resources/
│           └── config.properties        # Test credentials (DO NOT COMMIT)
└── doc/
    └── ...                              # Course guidelines
```
...
```properties
instagram.username=your_test_account_username
instagram.password=your_test_account_password
```
